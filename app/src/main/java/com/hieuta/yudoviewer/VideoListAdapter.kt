...
class VideoListAdapter(
    private val videos: List<SearchResultVideoDetails>,
    private val onDownloadClick: (SearchResultVideoDetails, ProgressBar) -> Unit
) :
    ...
    class VideoViewHolder(
        ...
        fun bind(video: SearchResultVideoDetails) {
            ...
            downloadButton.setOnClickListener {
                onDownloadClick(video, downloadProgressBar)
            }
        }
    }
}
